...
export default class VeiculosScreen extends React.Component {
  ...
  componentDidMount() {
    fetch(
      "http://192.168.1.113/grupo4-pws/web/api-v1/veiculo",
      {
        method: "GET",
        headers: {
    ...
    return (
      <View style={styles.bottomContainer}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity onPress={() => this.props.navigation.navigate("VeiculosDetalhes", { veiculoid: item.id })}>
