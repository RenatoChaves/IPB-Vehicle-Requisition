  ...
  >
    ...
    <Tabs.Screen
      ...
      options={{
        ...
        tabBarIcon: ({}) => (
          <Image
            source={require("../../assets/requisicoes.png")}
    ...
    />
    <Tabs.Screen
      name="ManutencoesStack"
      component={ManutencoesStackScreen}
      options={{
        title: "Manutenções",
        headerLeft: () => (
          <Icon.Button
...
const ManutencoesStack = createStackNavigator();
const ManutencoesStackScreen = ({ navigation }) => (
  <ManutencoesStack.Navigator
    initialRouteName="Manutencoes"
    screenOptions={{
      headerStyle: {
        backgroundColor: "#810053",
      },
  ...
  >
    <ManutencoesStack.Screen
      name="Manutencoes"
      component={ManutencoesScreen}
      options={{
        title: "Veiculos a aguardar por Manutenção",
        headerLeft: () => (
          <Icon.Button
            name="ios-menu"
            size={25}
    ...
    <ManutencoesStack.Screen
      ...
      component={adicionarManutencaoScreen}
      options={{
        title: "Manutenções",
        headerLeft: () => (
          <Icon.Button
    ...
    <ManutencoesStack.Screen
      ...
      component={manutencaoCreateScreen}
      options={{
